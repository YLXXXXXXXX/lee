...
public interface ProductDao extends JpaRepository<Product, Integer> {
     ...
     * @return
     */
    Page<Product> findByTitleIsLikeAndStatusGreaterThanEqual(String keyword,int status, Pageable pageable);


    Page<Product> findAllByStatusGreaterThanEqual(int status, Pageable pageable);
     ...
     * @return
     */
    Page<Product> findByTitleIsLikeAndStatus(String keyword, int status,Pageable pageable);
    ...
    Product findByIdAndSecret(int id,String secret);
}
